...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    final private ForecastAdapterOnClickHandler mClickHandeler;
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mClickHandeler.onClick(mCursor.getLong(dateColumnIndex), this);
        }
    }
    ...
    public ForecastAdapter(Context context, ForecastAdapterOnClickHandler mClickHandeler, View mEmptyView) {
        mContext = context;
